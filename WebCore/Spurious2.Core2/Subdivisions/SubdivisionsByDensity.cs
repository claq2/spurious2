...
public class SubdivisionsByDensity : Specification<Subdivision>
{
        ...
        int limit)
    {
        ...
        //static ISpecificationBuilder<Subdivision> DetermineOrderQuery(ISpecificationBuilder<Subdivision> subdivsQuery, Expression<Func<Subdivision, decimal?>> keySelector, EndOfDistribution endOfDistribution)
