...
public partial class Initial : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("pi_firstkey", x => x.Id);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK__Product__3214EC07712F54DE", x => x.Id);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Category = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                Volume = table.Column<int>(type: "int", nullable: true),
                ProductDone = table.Column<bool>(type: "bit", nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("pri_firstkey", x => x.Id);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                BeerVolume = table.Column<long>(type: "bigint", nullable: false),
                WineVolume = table.Column<long>(type: "bigint", nullable: false),
                SpiritsVolume = table.Column<long>(type: "bigint", nullable: false),
                ...
                MedianAfterTaxIncome = table.Column<int>(type: "int", nullable: false),
                AverageAfterTaxIncome = table.Column<int>(type: "int", nullable: false),
            ...
            constraints: table =>
            {
                table.PrimaryKey("firstkey", x => x.Id);
            });
