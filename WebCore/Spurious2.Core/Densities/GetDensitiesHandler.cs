...
public class GetDensitiesHandler : IRequestHandler<GetDensitiesRequest>
{
    ...
    public Task Handle(GetDensitiesRequest request, CancellationToken cancellationToken)
    {
