...
public class SpuriousService(IReadRepositoryBase<Subdivision> subdivisionRepository, ILogger<SpuriousService> logger)
{
    private static readonly List<Subdivision> subdivisions = [new()];
    ...
    {
        // TODO: Load subdivisions into in-memory list for fallback
    }
    ...
    public async Task<string> GetBoundaryForSubdivision(int subdivisionId, CancellationToken cancellationToken)
    {
        ...
        catch (Exception ex)
        {
            ...
            subdivGeom = spec.Evaluate(subdivisions).SingleOrDefault();
        }
        ...
        CancellationToken cancellationToken)
    {
        ...
        catch (Exception ex)
        {
            ...
            subdivs = [.. spec.Evaluate(subdivisions)];
        }
